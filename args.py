...
def get_parser():
    ...
    parser.add_argument('--log_dir', default='./logs/', help='path where to save logs')
    parser.add_argument('--lr', default=0.001, type=float, help='the initial learning rate')
    ...
    parser.add_argument('--multimask', action='store_true', help='if true, use multimask')
    ...
    parser.add_argument('--wd', '--weight-decay', default=0.001, type=float, metavar='W', help='weight decay',
                        dest='weight_decay')
